...
def paired_random_crop(img_gts, img_lqs, lq_patch_size, scale, gt_path):
    ...
    h_lq, w_lq, _ = img_lqs[0].shape[0], img_lqs[0].shape[1], img_lqs[0].shape[2]
    h_gt, w_gt, _ = img_gts[0].shape[0], img_gts[0].shape[1], img_gts[0].shape[2]
    ...
    # randomly choose top and left coordinates for lq patch 随机选择lq patch的顶部和左侧坐标
