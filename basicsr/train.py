...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '-opt', type=str, required=False, default='../options/train/TDD.yml', help='Path to option YAML file.')
    parser.add_argument(
        '--launcher',
    ...
    parser.add_argument('--input_path', type=str, required=False, default=r' ', help='The path to the input image. For single image inference only.')
    parser.add_argument('--output_path', type=str, required=False, default=' ', help='The path to the output image. For single image inference only.')
